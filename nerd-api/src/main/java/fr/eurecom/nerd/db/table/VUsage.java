...
public class VUsage {
    ...
    public VUsage(String date, int dailyUsage) {
        this.date = date;
    ...
    public static final Comparator<VUsage> DESC = 
            new Comparator<VUsage>() {
                public int compare(VUsage u1, VUsage u2) {                     
                    return -1*u1.getDate().compareTo(u2.getDate());
                }
            };
}
