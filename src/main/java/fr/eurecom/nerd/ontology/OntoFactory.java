...
public enum OntoFactory {
    INSTANCE;

    public static Mapper mapper = Mapper.getMapper();
    static {
        mapper.init( 
                     PropFactory.config.getProperty("fr.eurecom.nerd.ontology.mapping.core"),
                     PropFactory.config.getProperty("fr.eurecom.nerd.ontology.mapping.extended")
                    );
    }
}
